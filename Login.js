      ...
      const onHandleLogin = () => {
        if (email !== '' && password !== '') {
          signInWithEmailAndPassword(auth, email, password)
            ...
            .catch((err) => {
              Alert.alert('Login error', 'Email and password are not correct');
            });
        }
      };
        ...
        <Box w="100%" h="100%" justifyContent="center" alignItems="center">
            ...
            >
                ...
                <VStack space="lg" pt="$4">
                    <Button size="sm" backgroundColor={colors.primary} onPress={(onHandleLogin)}>
            ...
            {/* Go to sign up */}
            <Box flexDirection="row" top={600} position="absolute">
