			...
			<View>
				{messages.map((messageData, index) => (
					<View key={index}>
						{messageData.message && (
							<View style={{
								backgroundColor: messageData.currentUserSent ? '{white}' : '{gray}', // Set background color based on currentUserSent
								padding: 10,
								marginVertical: 5,
	...
	return (
		...
		<Box w="100%" h="100%">
			...
			<VStack space="xs" alignItems="left" p="$3" width="100%">
				<Heading lineHeight={60} fontSize="$3xl" fontWeight="$extrabold" color={colors.secondary} m={2}>
					To: {recipient}
				</Heading>
			</VStack>
