...
import { VStack, HStack, Heading, Box, Button, ButtonText, Avatar, AvatarFallbackText, AvatarImage, Text, Pressable, MaterialCommunityIcons } from '@gluestack-ui/themed';
            ...
            <VStack space="xs" pb="$2" py="$3" alignItems="center">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <Text px="$10" fontSize={15} color={colors.black}>
                            {bio}
                        </Text>
